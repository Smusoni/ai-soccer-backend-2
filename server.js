...
const APP_ORIGINS = (process.env.APP_ORIGINS ||
  'https://smusoni.github.io/ai-soccer-backend-2,http://localhost:8080,http://localhost:3000')
  .split(',')
  .map(s => s.trim())
  .filter(Boolean);
...
// Migration endpoint removed - run migrations locally with: node migrate.js
